...
<head>
  ...
  <title>Réinitialiser votre mot de passe — Massarek</title>
</head>
          ...
          <tr>
            <td align="center" style="background:linear-gradient(135deg,#1e3a8a,#0e7490);border-radius:16px 16px 0 0;padding:36px 40px;">
              <div style="display:inline-flex;align-items:center;gap:10px;">
                <div style="width:36px;height:36px;background:linear-gradient(135deg,#22d3ee,#2563eb);border-radius:10px;display:inline-block;vertical-align:middle;"></div>
          ...
          <tr>
            <td style="background:#0f1f38;padding:40px;border-left:1px solid rgba(34,211,238,0.1);border-right:1px solid rgba(34,211,238,0.1);">
              ...
              <p style="margin:0 0 32px;font-size:15px;color:rgba(148,163,184,1);line-height:1.7;">
                Nous avons reçu une demande de réinitialisation du mot de passe pour votre compte <strong style="color:#f0f9ff;">Massarek</strong>. Cliquez sur le bouton ci-dessous pour choisir un nouveau mot de passe.
              </p>
              ...
              <table cellpadding="0" cellspacing="0" style="margin:0 auto 32px;">
                <tr>
                  <td align="center" style="background:linear-gradient(135deg,#2563eb,#0e7490);border-radius:12px;box-shadow:0 0 32px rgba(34,211,238,0.25);">
                    <a href="{{ $resetLink }}" style="display:inline-block;padding:16px 40px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:0.02em;">
                ...
                <tr>
                  <td style="background:rgba(34,211,238,0.06);border-left:3px solid #22d3ee;border-radius:0 8px 8px 0;padding:14px 18px;">
                    <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.6;">
                      ...
                      Ce lien expire dans <strong style="color:#f0f9ff;">60 minutes</strong>. Si vous n'avez pas demandé cette réinitialisation, ignorez cet email.
                    </p>
                  </td>
                </tr>
              </table>
