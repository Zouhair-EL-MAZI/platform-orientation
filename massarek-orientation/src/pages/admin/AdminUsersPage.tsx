...
const mockUsers = [
  { id: 1, name: "Ahmed Benali", email: "ahmed@example.com", role: "user", tests: 3, status: "Active", verified: true, joined: "2026-04-10", lastActive: "2h ago" },
  { id: 2, name: "Sara Mansouri", email: "sara@example.com", role: "user", tests: 5, status: "Active", verified: true, joined: "2026-04-12", lastActive: "5h ago" },
  { id: 3, name: "Youssef Khalil", email: "youssef@example.com", role: "user", tests: 1, status: "Inactive", verified: false, joined: "2026-04-15", lastActive: "5d ago" },
  { id: 4, name: "Fatima Zahra", email: "fatima@example.com", role: "user", tests: 4, status: "Active", verified: true, joined: "2026-04-18", lastActive: "1d ago" },
  { id: 5, name: "Omar Hamdouni", email: "omar@example.com", role: "user", tests: 2, status: "Active", verified: true, joined: "2026-04-20", lastActive: "3d ago" },
  { id: 6, name: "Nadia Chraibi", email: "nadia@example.com", role: "admin", tests: 0, status: "Active", verified: true, joined: "2026-03-01", lastActive: "10 min ago" },
  { id: 7, name: "Karim Alaoui", email: "karim@example.com", role: "user", tests: 6, status: "Active", verified: true, joined: "2026-04-22", lastActive: "30 min ago" },
  { id: 8, name: "Zineb Tahiri", email: "zineb@example.com", role: "user", tests: 0, status: "Pending", verified: false, joined: "2026-05-01", lastActive: "Never" },
];
