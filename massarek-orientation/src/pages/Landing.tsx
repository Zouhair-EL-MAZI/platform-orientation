...
const Landing = () => {
  ...
  return (
    <div style={{ background: "var(--ms-bg-base)" }}>
      ...
      {/* HERO */}
      <section id="home" className="relative overflow-hidden px-6 md:px-12 pt-10 pb-28">
        {/* Grid lines */}
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }} className="relative">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full px-8 py-3.5 text-base font-bold text-white transition-all duration-300 hover:-translate-y-0.5 glow-pulse"
                style={{
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full px-8 py-3.5 text-base font-semibold transition-all duration-300 hover:-translate-y-0.5"
                style={{
